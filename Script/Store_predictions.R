...
# Load data ####
df_train <- read.csv("C:/Respaldo FR/Ubiqum/Proyectos/Datathon_store/Data_sets/train.csv")
df_results <- read.csv("C:/Respaldo FR/Ubiqum/Proyectos/Datathon_store/Data_sets/test.csv")
